...
const MortgageRelief = () => {
  ...
  first-letter:mr-3 first-letter:float-left mission text-2xl md:text-4xl text-left row-start-2 row-span-2 m-20 grow tracking-widest">
        We strive to empower and assist individuals and families through education, information and relationships. Our team of professionals possess the knowledge, honesty and compassion needed to protect the homeowner while helping them produce the best outcome for themselves and their families.We are dedicated to providing customers with the support they need to succeed through our innovative investment resources and 20 plus years of experience it the industry.
      </h1>
    </div>
  );
};
